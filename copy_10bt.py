...
enc = PreTrainedTokenizerFast.from_pretrained("/home/chinmay/gcp_tokenizer")

# eot = enc.add_special_tokens['<|endoftext|>'] # end of text token
def tokenize(doc):
  # tokenizes a single document and returns a numpy array of uint32 tokens
  # tokens = [eot] # the special <|endoftext|> token delimits all documents
  tokens = []
  tokens.extend(enc(doc["text"]))
